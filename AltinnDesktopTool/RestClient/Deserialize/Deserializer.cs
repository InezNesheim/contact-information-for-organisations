    ...
    public class Deserializer
    {
        ...
        public static List<Organization> DeserializeOrganizations(string json)
        {
            ...
            try
            {
                ...
                orgs = JsonConvert.DeserializeObject<List<Organization>>(organization.ToString(), new JsonConverter[] { new HalJsonConverter() });
        ...
        public static List<T> DeserializeHalJsonResource<T>(string json) where T : HalJsonResource
        {
